...
import com.appspot.noqodo.conference.model.Conference;
import com.appspot.noqodo.conference.model.ConferenceCollection;
import com.appspot.noqodo.conference.model.Profile;
import com.appspot.noqodo.conference.model.WrappedBoolean;
...
public class ConferenceUtils {
    ...
    private static com.appspot.noqodo.conference.Conference sApiServiceHandler;
     ...
     * This list includes information about what {@link com.appspot.noqodo.conference.model.Conference}s
    ...
    public static List<DecoratedConference> getConferences()
        ...
        com.appspot.noqodo.conference.Conference.QueryConferences
    ...
    /**
     * Registers user for a {@link com.appspot.noqodo.conference.model.Conference}
     *
     * @param conference
     * @return
     * @throws ConferenceException
    ...
    public static boolean registerForConference(Conference conference)
        ...
        com.appspot.noqodo.conference.Conference.RegisterForConference
    ...
    /**
     * Unregisters user from a {@link com.appspot.noqodo.conference.model.Conference}.
     *
     * @param conference
     * @return
     * @throws ConferenceException
    ...
    public static boolean unregisterFromConference(Conference conference)
        ...
        com.appspot.noqodo.conference.Conference.UnregisterFromConference
    ...
    /**
     * Returns the user {@link com.appspot.noqodo.conference.model.Profile}. Can
    ...
    public static Profile getProfile() throws ConferenceException, IOException {
        ...
        com.appspot.noqodo.conference.Conference.GetProfile getProfile =
                sApiServiceHandler.getProfile();
        return getProfile.execute();
    }

    /**
     * Build and returns an instance of {@link com.appspot.noqodo.conference.Conference}
     *
     * @param context
     * @param email
     * @return
     */
    public static com.appspot.noqodo.conference.Conference buildServiceHandler(
            Context context, String email) {
        GoogleAccountCredential credential = GoogleAccountCredential.usingAudience(
                context, AppConstants.AUDIENCE);
        credential.setSelectedAccountName(email);

        com.appspot.noqodo.conference.Conference.Builder builder
                = new com.appspot.noqodo.conference.Conference.Builder(
